...
keywords = {'social': 'access_modifier', 'secure': 'access_modifier', 'secret': 'access_modifier',
            ...
            'continue': 'continue_break', 'break': 'continue_break',
            'str': 'str', 'if': 'if', 'elsif': 'elsif', 'match': 'match', 'case': 'case', 'while': 'while', 'for': 'for', 'func': 'func', 
            'void': 'void', 'return': 'return', 'type': 'type', 'make': 'make', 'self': 'self', 'grand': 'grand', 'enhance': 'enhance',
            'abstract': 'abstract', 'const': 'const', 'passive': 'passive', 'as': 'as', 'constructor': 'constructor', 
            'try': 'try', 'except': 'except', 'finally': 'finally', 'raise': 'raise', 'null': 'null', 'main': 'main'}
